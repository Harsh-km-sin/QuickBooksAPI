...
public interface IVendorRepository
{
    ...
    Task<PagedResult<Vendor>> GetPagedByUserAndRealmAsync(int userId, string realmId, int page, int pageSize, string? search, bool? activeFilter = true, string? sortBy = null, bool sortDescending = false);
    ...
    Task<bool> SoftDeleteAsync(int userId, string realmId, string qboId);
}
