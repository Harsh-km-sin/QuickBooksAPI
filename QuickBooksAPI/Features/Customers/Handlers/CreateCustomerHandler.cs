...
public sealed class CreateCustomerHandler
{
    ...
    public CreateCustomerHandler(IRequestContext requestContext, ICustomerQboCommandService commands)
    {
        _requestContext = requestContext;
        _commands = commands;
    }

    public async Task<ApiResponse<string>> HandleAsync(CreateCustomerRequest request)
    {
