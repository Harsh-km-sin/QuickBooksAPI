...
public sealed class CreateInvoiceHandler
{
    ...
    public CreateInvoiceHandler(IRequestContext requestContext, IInvoiceQboCommandService commands)
    {
        _requestContext = requestContext;
        _commands = commands;
    }

    public async Task<ApiResponse<string>> HandleAsync(CreateInvoiceRequest request)
    {
