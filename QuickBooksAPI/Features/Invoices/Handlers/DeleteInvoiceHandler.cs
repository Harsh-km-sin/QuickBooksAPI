...
public sealed class DeleteInvoiceHandler
{
    ...
    public DeleteInvoiceHandler(IRequestContext requestContext, IInvoiceQboCommandService commands)
    {
        _requestContext = requestContext;
        _commands = commands;
    }

    public async Task<ApiResponse<string>> HandleAsync(DeleteInvoiceRequest request)
    {
